...
def send_email_provider(
    service_name, api_key, api_secret, subject, message, recipient_list
):
    ...
    if (
        not service_name
        or not api_key
        or (service_name == "Mailjet" and not api_secret)
    ):
        return False
...
class PaymentViewSet(viewsets.ModelViewSet):
    ...
    def create_payment_intent(self, request):
        ...
        api_secret = (
            request.email_service_api_secret if service_name == "Mailjet" else None
        )
