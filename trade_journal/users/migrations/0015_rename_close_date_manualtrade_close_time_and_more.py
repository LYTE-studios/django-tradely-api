...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='tradeaccount',
            name='platform',
            field=models.CharField(choices=[('MetaTrader4', 'Meta Trader 4'), ('MetaTrader5', 'Meta Trader 5'), ('TradeLocker', 'Trade Locker'), ('CTrader', 'C Trader'), ('Manual', 'Manual')], default='Manual', max_length=64),
        ),
        migrations.AddField(
            model_name='tradeaccount',
            name='status',
